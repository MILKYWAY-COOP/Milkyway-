...
export default function Cards() {
  ...
  return (
    <div
      className="px-[80px] flex flex-col w-auto align-center justify-center p-8 bg-fadedDarkBlue rounded-[20px] relative"
      ...
      <div className="relative w-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {categories.map((category, index) => (
          <motion.div
            ...
            className="bg-white rounded-lg p-4 w-[250px] h-[250px] overflow-hidden relative cursor-pointer"
          >
